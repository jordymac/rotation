// Enhanced Audio Matching Service
...
function calculateMixCompatibility(trackMix: MixInfo, candidateMix: MixInfo): number {
  ...
  // 4. Extended and remix can sometimes be compatible (both are longer versions)
  if ((trackMix.mixType === 'extended' && candidateMix.mixType === 'remix') ||
      (trackMix.mixType === 'remix' && candidateMix.mixType === 'extended')) {
    return 60;
  }
...
// Main enhanced audio matching service
export class EnhancedAudioMatchingService {
